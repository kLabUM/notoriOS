...
#define emFile_SPI0_INTERNAL_CLOCK             (0u)

#if(0u != emFile_SPI0_INTERNAL_CLOCK)
    #include "emFile_SPI0_IntClock.h"
#endif /* (0u != emFile_SPI0_INTERNAL_CLOCK) */

#define emFile_SPI0_MODE                       (1u)
#define emFile_SPI0_DATA_WIDTH                 (8u)
#define emFile_SPI0_MODE_USE_ZERO              (1u)
#define emFile_SPI0_BIDIRECTIONAL_MODE         (0u)

/* Internal interrupt handling */
#define emFile_SPI0_TX_BUFFER_SIZE             (4u)
#define emFile_SPI0_RX_BUFFER_SIZE             (4u)
#define emFile_SPI0_INTERNAL_TX_INT_ENABLED    (0u)
#define emFile_SPI0_INTERNAL_RX_INT_ENABLED    (0u)

#define emFile_SPI0_SINGLE_REG_SIZE            (8u)
#define emFile_SPI0_USE_SECOND_DATAPATH        (emFile_SPI0_DATA_WIDTH > emFile_SPI0_SINGLE_REG_SIZE)

#define emFile_SPI0_FIFO_SIZE                  (4u)
#define emFile_SPI0_TX_SOFTWARE_BUF_ENABLED    ((0u != emFile_SPI0_INTERNAL_TX_INT_ENABLED) && \
                                                     (emFile_SPI0_TX_BUFFER_SIZE > emFile_SPI0_FIFO_SIZE))

#define emFile_SPI0_RX_SOFTWARE_BUF_ENABLED    ((0u != emFile_SPI0_INTERNAL_RX_INT_ENABLED) && \
                                                     (emFile_SPI0_RX_BUFFER_SIZE > emFile_SPI0_FIFO_SIZE))
...
void  emFile_SPI0_PutArray(const uint8 buffer[], uint8 byteCount) \
                                                            ;

#if(0u != emFile_SPI0_BIDIRECTIONAL_MODE)
    void  emFile_SPI0_TxEnable(void)                   ;
    void  emFile_SPI0_TxDisable(void)                  ;
#endif /* (0u != emFile_SPI0_BIDIRECTIONAL_MODE) */
...
extern uint8 emFile_SPI0_initVar;
...
#define emFile_SPI0_TX_ISR_NUMBER     ((uint8) (emFile_SPI0_TxInternalInterrupt__INTC_NUMBER))
#define emFile_SPI0_RX_ISR_NUMBER     ((uint8) (emFile_SPI0_RxInternalInterrupt__INTC_NUMBER))

#define emFile_SPI0_TX_ISR_PRIORITY   ((uint8) (emFile_SPI0_TxInternalInterrupt__INTC_PRIOR_NUM))
#define emFile_SPI0_RX_ISR_PRIORITY   ((uint8) (emFile_SPI0_RxInternalInterrupt__INTC_PRIOR_NUM))
...
#define emFile_SPI0_INT_ON_SPI_DONE    ((uint8) (0u   << emFile_SPI0_STS_SPI_DONE_SHIFT))
#define emFile_SPI0_INT_ON_TX_EMPTY    ((uint8) (0u   << emFile_SPI0_STS_TX_FIFO_EMPTY_SHIFT))
#define emFile_SPI0_INT_ON_TX_NOT_FULL ((uint8) (0u << \
                                                                           emFile_SPI0_STS_TX_FIFO_NOT_FULL_SHIFT))
#define emFile_SPI0_INT_ON_BYTE_COMP   ((uint8) (0u  << emFile_SPI0_STS_BYTE_COMPLETE_SHIFT))
#define emFile_SPI0_INT_ON_SPI_IDLE    ((uint8) (0u   << emFile_SPI0_STS_SPI_IDLE_SHIFT))

/* Disable TX_NOT_FULL if software buffer is used */
#define emFile_SPI0_INT_ON_TX_NOT_FULL_DEF ((emFile_SPI0_TX_SOFTWARE_BUF_ENABLED) ? \
                                                                        (0u) : (emFile_SPI0_INT_ON_TX_NOT_FULL))

/* TX interrupt mask */
#define emFile_SPI0_TX_INIT_INTERRUPTS_MASK    (emFile_SPI0_INT_ON_SPI_DONE  | \
                                                     emFile_SPI0_INT_ON_TX_EMPTY  | \
                                                     emFile_SPI0_INT_ON_TX_NOT_FULL_DEF | \
                                                     emFile_SPI0_INT_ON_BYTE_COMP | \
                                                     emFile_SPI0_INT_ON_SPI_IDLE)

#define emFile_SPI0_INT_ON_RX_FULL         ((uint8) (0u << \
                                                                          emFile_SPI0_STS_RX_FIFO_FULL_SHIFT))
#define emFile_SPI0_INT_ON_RX_NOT_EMPTY    ((uint8) (0u << \
                                                                          emFile_SPI0_STS_RX_FIFO_NOT_EMPTY_SHIFT))
#define emFile_SPI0_INT_ON_RX_OVER         ((uint8) (0u << \
                                                                          emFile_SPI0_STS_RX_FIFO_OVERRUN_SHIFT))

/* RX interrupt mask */
#define emFile_SPI0_RX_INIT_INTERRUPTS_MASK    (emFile_SPI0_INT_ON_RX_FULL      | \
                                                     emFile_SPI0_INT_ON_RX_NOT_EMPTY | \
                                                     emFile_SPI0_INT_ON_RX_OVER)
/* Nubmer of bits to receive/transmit */
#define emFile_SPI0_BITCTR_INIT            (((uint8) (emFile_SPI0_DATA_WIDTH << 1u)) - 1u)
...
***************************************/
    ...
    #define emFile_SPI0_RXDATA_PTR (  (reg8 *) \
                                                emFile_SPI0_BSPIM_sR8_Dp_u0__F1_REG)
#else   /* PSOC4 */
    #if(emFile_SPI0_USE_SECOND_DATAPATH)
        #define emFile_SPI0_TXDATA_REG (* (reg16 *) \
                                          emFile_SPI0_BSPIM_sR8_Dp_u0__16BIT_F0_REG)
        #define emFile_SPI0_TXDATA_PTR (  (reg16 *) \
                                          emFile_SPI0_BSPIM_sR8_Dp_u0__16BIT_F0_REG)
        #define emFile_SPI0_RXDATA_REG (* (reg16 *) \
                                          emFile_SPI0_BSPIM_sR8_Dp_u0__16BIT_F1_REG)
        #define emFile_SPI0_RXDATA_PTR         (  (reg16 *) \
                                          emFile_SPI0_BSPIM_sR8_Dp_u0__16BIT_F1_REG)
    #else
        #define emFile_SPI0_TXDATA_REG (* (reg8 *) \
                                                emFile_SPI0_BSPIM_sR8_Dp_u0__F0_REG)
        ...
        #define emFile_SPI0_RXDATA_PTR (  (reg8 *) \
                                                emFile_SPI0_BSPIM_sR8_Dp_u0__F1_REG)
    #endif /* (emFile_SPI0_USE_SECOND_DATAPATH) */
...
#define emFile_SPI0_STS_SPI_DONE           ((uint8) (0x01u << emFile_SPI0_STS_SPI_DONE_SHIFT))
#define emFile_SPI0_STS_TX_FIFO_EMPTY      ((uint8) (0x01u << emFile_SPI0_STS_TX_FIFO_EMPTY_SHIFT))
#define emFile_SPI0_STS_TX_FIFO_NOT_FULL   ((uint8) (0x01u << emFile_SPI0_STS_TX_FIFO_NOT_FULL_SHIFT))
#define emFile_SPI0_STS_BYTE_COMPLETE      ((uint8) (0x01u << emFile_SPI0_STS_BYTE_COMPLETE_SHIFT))
#define emFile_SPI0_STS_SPI_IDLE           ((uint8) (0x01u << emFile_SPI0_STS_SPI_IDLE_SHIFT))
#define emFile_SPI0_STS_RX_FIFO_FULL       ((uint8) (0x01u << emFile_SPI0_STS_RX_FIFO_FULL_SHIFT))
#define emFile_SPI0_STS_RX_FIFO_NOT_EMPTY  ((uint8) (0x01u << emFile_SPI0_STS_RX_FIFO_NOT_EMPTY_SHIFT))
#define emFile_SPI0_STS_RX_FIFO_OVERRUN    ((uint8) (0x01u << emFile_SPI0_STS_RX_FIFO_OVERRUN_SHIFT))
...
#define emFile_SPI0_INT_ENABLE     (0x10u) /* Enable interrupt from statusi */
#define emFile_SPI0_TX_FIFO_CLR    (0x01u) /* F0 - TX FIFO */
#define emFile_SPI0_RX_FIFO_CLR    (0x02u) /* F1 - RX FIFO */
#define emFile_SPI0_FIFO_CLR       (emFile_SPI0_TX_FIFO_CLR | emFile_SPI0_RX_FIFO_CLR)

/* Bit Counter (7-bit) Control Register Bit Definitions */
/* As defined by the Register map for the AUX Control Register */
#define emFile_SPI0_CNTR_ENABLE    (0x20u) /* Enable CNT7 */
...
/* Component disabled */
#define emFile_SPI0_DISABLED   (0u)
...
#define emFile_SPI0_IS_ENABLED (0u != (emFile_SPI0_TX_STATUS_ACTL_REG & emFile_SPI0_INT_ENABLE))
...
#define emFile_SPI0_INIT_INTERRUPTS_MASK  (emFile_SPI0_INT_ON_SPI_DONE     | \
                                                emFile_SPI0_INT_ON_TX_EMPTY     | \
                                                emFile_SPI0_INT_ON_TX_NOT_FULL_DEF  | \
                                                emFile_SPI0_INT_ON_RX_FULL      | \
                                                emFile_SPI0_INT_ON_RX_NOT_EMPTY | \
                                                emFile_SPI0_INT_ON_RX_OVER      | \
                                                emFile_SPI0_INT_ON_BYTE_COMP)
...
#define emFile_SPI0_DataWidth                  (emFile_SPI0_DATA_WIDTH)
#define emFile_SPI0_InternalClockUsed          (emFile_SPI0_INTERNAL_CLOCK)
#define emFile_SPI0_InternalTxInterruptEnabled (emFile_SPI0_INTERNAL_TX_INT_ENABLED)
#define emFile_SPI0_InternalRxInterruptEnabled (emFile_SPI0_INTERNAL_RX_INT_ENABLED)
#define emFile_SPI0_ModeUseZero                (emFile_SPI0_MODE_USE_ZERO)
#define emFile_SPI0_BidirectionalMode          (emFile_SPI0_BIDIRECTIONAL_MODE)
#define emFile_SPI0_Mode                       (emFile_SPI0_MODE)
#define emFile_SPI0_DATAWIDHT                  (emFile_SPI0_DATA_WIDTH)
#define emFile_SPI0_InternalInterruptEnabled   (0u)

#define emFile_SPI0_TXBUFFERSIZE   (emFile_SPI0_TX_BUFFER_SIZE)
#define emFile_SPI0_RXBUFFERSIZE   (emFile_SPI0_RX_BUFFER_SIZE)

#define emFile_SPI0_TXBUFFER       emFile_SPI0_txBuffer
#define emFile_SPI0_RXBUFFER       emFile_SPI0_rxBuffer
