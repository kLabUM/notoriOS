...
#define emFile_Clock_1_SetDivider(clkDivider)         emFile_Clock_1_SetDividerRegister(clkDivider, 1u)
#define emFile_Clock_1_SetDividerValue(clkDivider)    emFile_Clock_1_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define emFile_Clock_1_SetPhaseValue(clkPhase)        emFile_Clock_1_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(emFile_Clock_1__CFG3) */
