...
*
* \funcusage
*  \snippet Pin_Sampler_Completed_Sample_SUT.c usage_Pin_Sampler_Completed_Sample_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_Sampler_Completed_Sample_SUT.c usage_Pin_Sampler_Completed_Sample_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_Sampler_Completed_Sample_SUT.c usage_Pin_Sampler_Completed_Sample_Read  
*******************************************************************************/
...
* preferred Pin_Sampler_Completed_Sample_Read() API because the 
* Pin_Sampler_Completed_Sample_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Pin_Sampler_Completed_Sample_SUT.c usage_Pin_Sampler_Completed_Sample_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Pin_Sampler_Completed_Sample_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Pin_Sampler_Completed_Sample_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Pin_Sampler_Completed_Sample_0_INTR       (First pin in the list)
    *  - Pin_Sampler_Completed_Sample_1_INTR       (Second pin in the list)
    *  - ...
    *  - Pin_Sampler_Completed_Sample_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Pin_Sampler_Completed_Sample_SUT.c usage_Pin_Sampler_Completed_Sample_SetInterruptMode
    *******************************************************************************/
    void Pin_Sampler_Completed_Sample_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Pin_Sampler_Completed_Sample_0_INTR) != 0u) 
		{ 
			 Pin_Sampler_Completed_Sample_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Pin_Sampler_Completed_Sample_SUT.c usage_Pin_Sampler_Completed_Sample_ClearInterrupt
    *******************************************************************************/
