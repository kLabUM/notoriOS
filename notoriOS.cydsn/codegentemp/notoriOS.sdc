...
# Project: C:\notoriOS\notoriOS.cydsn\notoriOS.cyprj
# Date: Tue, 19 Jul 2022 19:31:52 GMT
#set_units -time ns
...
create_generated_clock -name {Downstream_Clock_IMO} -source [get_pins {ClockBlock/clk_sync}] -edges {1 313 627} [list [get_pins {ClockBlock/dclk_glb_4}]]
create_generated_clock -name {Clock_IMO} -source [get_pins {ClockBlock/clk_sync}] -edges {1 313 627} [list [get_pins {ClockBlock/dclk_glb_5}]]
create_generated_clock -name {FastClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 24001 48001} [list [get_pins {ClockBlock/dclk_glb_6}]]
create_generated_clock -name {SlowClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 240001 480001} [list [get_pins {ClockBlock/dclk_glb_7}]]
...
# Project: C:\notoriOS\notoriOS.cydsn\notoriOS.cyprj
# Date: Tue, 19 Jul 2022 19:31:38 GMT
