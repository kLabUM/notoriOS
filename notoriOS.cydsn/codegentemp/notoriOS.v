...
module UART_v2_50_8 (
	...
	cy_clock_v1_0
		#(.id("a2e6e23d-e1fe-415e-af98-64f2080584c9/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
    ...
    assign Net_316 = Net_40 | Net_318;


    assign Net_46 = ~Net_50;

	wire [0:0] tmpOE__Pin_Regulator_PWM_net;
	wire [0:0] tmpFB_0__Pin_Regulator_PWM_net;
	wire [0:0] tmpIO_0__Pin_Regulator_PWM_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Regulator_PWM_net;
	electrical [0:0] tmpSIOVREF__Pin_Regulator_PWM_net;

	cy_psoc3_pins_v1_10
		#(.id("1531d87b-bc23-474b-b1ec-d39f308af2a7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Regulator_PWM
		 (.oe(tmpOE__Pin_Regulator_PWM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Regulator_PWM_net[0:0]}),
		  .io({tmpIO_0__Pin_Regulator_PWM_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Regulator_PWM_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Regulator_PWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Regulator_PWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
