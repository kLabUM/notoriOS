...
module top ;
	...
	wire [0:0] tmpOE__Valve_OPEN_net;
	wire [0:0] tmpFB_0__Valve_OPEN_net;
	wire [0:0] tmpIO_0__Valve_OPEN_net;
	wire [0:0] tmpINTERRUPT_0__Valve_OPEN_net;
	electrical [0:0] tmpSIOVREF__Valve_OPEN_net;

	cy_psoc3_pins_v1_10
		#(.id("a152c918-43c9-4eeb-b96f-559cddf20dfa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Valve_OPEN
		 (.oe(tmpOE__Valve_OPEN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Valve_OPEN_net[0:0]}),
		  .io({tmpIO_0__Valve_OPEN_net[0:0]}),
		  .siovref(tmpSIOVREF__Valve_OPEN_net),
		  .interrupt({tmpINTERRUPT_0__Valve_OPEN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Valve_OPEN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Valve_CLOSE_net;
	wire [0:0] tmpFB_0__Valve_CLOSE_net;
	wire [0:0] tmpIO_0__Valve_CLOSE_net;
	wire [0:0] tmpINTERRUPT_0__Valve_CLOSE_net;
	electrical [0:0] tmpSIOVREF__Valve_CLOSE_net;

	cy_psoc3_pins_v1_10
		#(.id("09bf007c-9052-40a6-b263-f9ce6b4288b8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Valve_CLOSE
		 (.oe(tmpOE__Valve_CLOSE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Valve_CLOSE_net[0:0]}),
		  .io({tmpIO_0__Valve_CLOSE_net[0:0]}),
		  .siovref(tmpSIOVREF__Valve_CLOSE_net),
		  .interrupt({tmpINTERRUPT_0__Valve_CLOSE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Valve_CLOSE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
