...
#define SlowClock_SetDivider(clkDivider)         SlowClock_SetDividerRegister(clkDivider, 1u)
#define SlowClock_SetDividerValue(clkDivider)    SlowClock_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define SlowClock_SetPhaseValue(clkPhase)        SlowClock_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(SlowClock__CFG3) */
