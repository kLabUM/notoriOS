...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the VBAT_READ_EN_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(VBAT_READ_EN__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in VBAT_READ_EN_SetInterruptMode() function.
     *  @{
     */
        #define VBAT_READ_EN_INTR_NONE      (uint16)(0x0000u)
        #define VBAT_READ_EN_INTR_RISING    (uint16)(0x0001u)
        #define VBAT_READ_EN_INTR_FALLING   (uint16)(0x0002u)
        #define VBAT_READ_EN_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define VBAT_READ_EN_INTR_MASK      (0x01u) 
#endif /* (VBAT_READ_EN__INTSTAT) */
...
/* SIO registers */
#if defined(VBAT_READ_EN__SIO_CFG)
    #define VBAT_READ_EN_SIO_HYST_EN        (* (reg8 *) VBAT_READ_EN__SIO_HYST_EN)
    #define VBAT_READ_EN_SIO_REG_HIFREQ     (* (reg8 *) VBAT_READ_EN__SIO_REG_HIFREQ)
    #define VBAT_READ_EN_SIO_CFG            (* (reg8 *) VBAT_READ_EN__SIO_CFG)
    #define VBAT_READ_EN_SIO_DIFF           (* (reg8 *) VBAT_READ_EN__SIO_DIFF)
#endif /* (VBAT_READ_EN__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define VBAT_READ_EN_0_INTTYPE_REG 		(* (reg8 *) VBAT_READ_EN__0__INTTYPE)
#endif /* (VBAT_READ_EN__INTSTAT) */
