...
static void emFile_Init(U8 Unit) CYREENTRANT
{
    ...
    case 0u:
        ...
        if (emFile_isInited0 == 0u)
        {
            ...
            emFile_Clock_1_SetDividerValue(BCLK__BUS_CLK__KHZ/emFile_STARTUP_FREQ);

            /* Start the clock */
            emFile_Clock_1_Start();
        ...
        break;
            ...
            case 1u:
                ...
                if (emFile_isInited1 == 0u)
                {
                    ...
                    /* Set the inital clock frequency to 400 KHz */
                    emFile_Clock_2_SetDividerValue(BCLK__BUS_CLK__KHZ/emFile_STARTUP_FREQ);

                    /* Start the clock */
                    emFile_Clock_2_Start();
            ...
            case 2u:
                ...
                if (emFile_isInited2 == 0u)
                {
                    ...
                    /* Set the inital clock frequency to 400 KHz */
                    emFile_Clock_3_SetDividerValue(BCLK__BUS_CLK__KHZ/emFile_STARTUP_FREQ);

                    /* Start the clock */
                    emFile_Clock_3_Start();
            ...
            case 3u:
                ...
                if (emFile_isInited3 == 0u)
                {
                    ...
                    /* Set the inital clock frequency to 400 KHz */
                    emFile_Clock_4_SetDividerValue(BCLK__BUS_CLK__KHZ/emFile_STARTUP_FREQ);

                    /* Start the clock */
                    emFile_Clock_4_Start();
...
static U8 emFile_ReadWriteSPI(U8 Unit, U8 Data) CYREENTRANT
{
    ...
    case 0u:
        ...
        /* Send Data */
        emFile_SPI0_WriteTxData(Data);

        /* Wait until all bits are shifted */
        while (0u == (emFile_SPI0_STS_SPI_DONE & emFile_SPI0_ReadTxStatus()));

        /* Read data */
        spiData = emFile_SPI0_ReadRxData();
        ...
        case 1u:
            ...
            /* Send Data */
            emFile_SPI1_WriteTxData(Data);

            /* Wait until all bits are shifted */
            while (0u == (emFile_SPI1_STS_SPI_DONE & emFile_SPI1_ReadTxStatus()));

            /* Read data */
            spiData = emFile_SPI1_ReadRxData();
        ...
        case 2u:
            ...
            /* Send Data */
            emFile_SPI2_WriteTxData(Data);

            /* Wait until all bits are shifted */
            while (0u == (emFile_SPI2_STS_SPI_DONE & emFile_SPI2_ReadTxStatus()));

            /* Read data */
            spiData = emFile_SPI2_ReadRxData();
        ...
        case 3u:
            ...
            /* Send Data */
            emFile_SPI3_WriteTxData(Data);

            /* Wait until all bits are shifted */
            while (0u == (emFile_SPI3_STS_SPI_DONE & emFile_SPI3_ReadTxStatus()));

            /* Read data */
            spiData = emFile_SPI3_ReadRxData();
   ...
   int wpState;
    ...
    case 0u:
            ...
            /* Based on physical switch state */
              wpState = (int)emFile_SPI0_WP_Read();
        ...
        case 1u:
                   ...
                   /* Based on physical switch state */
                wpState = (int)emFile_SPI1_WP_Read();
        ...
        case 2u:
                  ...
                  /* Based on physical switch state */
                wpState = (int)emFile_SPI2_WP_Read();
        ...
        case 3u:
                ...
                /* Based on physical switch state */
                wpState = (int)emFile_SPI3_WP_Read();
...
U16 FS_MMC_HW_X_SetMaxSpeed(U8 Unit, U16 MaxFreq)
{
    ...
    switch(Unit)
    {
        case 0u:
            emFile_Clock_1_Stop();
            emFile_Clock_1_SetDividerValue((U16)divResult);    /* update the frequency */
            emFile_Clock_1_Start();
            break;
        ...
        case 1u:
            ...
            emFile_Clock_2_Stop();
            emFile_Clock_2_SetDividerValue((U16)divResult);    /* update the frequency */
            emFile_Clock_2_Start();
            break;
        ...
        case 2u:
            ...
            emFile_Clock_3_Stop();
            emFile_Clock_3_SetDividerValue((U16)divResult);    /* update the frequency */
            emFile_Clock_3_Start();
            break;
        ...
        case 3u:
            ...
            emFile_Clock_4_Stop();
            emFile_Clock_4_SetDividerValue((U16)divResult);    /* update the frequency */
            emFile_Clock_4_Start();
            break;
