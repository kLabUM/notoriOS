...
#define Pin_Sampler_Sampler_Count_0_INTR	((uint16)((uint16)0x0001u << Pin_Sampler_Sampler_Count__0__SHIFT))

#define Pin_Sampler_Sampler_Count_INTR_ALL	 ((uint16)(Pin_Sampler_Sampler_Count_0_INTR))
